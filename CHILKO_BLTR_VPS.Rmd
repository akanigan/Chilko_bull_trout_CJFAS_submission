...
1. To filter raw VPS data and compile required data sets, including smolt outmigration density, solar data, receiver and reference tag deployment data, and bull trout tagging data, run the code in 'Step 1. Prepare datasets'. Alternatively, processed data can be loaded directly in 'Step 2. Calculate movement metrics'. 
...
#renv::snapshot()    # captures exact package versions
...
Note that the data are loaded from .RDS files, though original data are also available as .CSV files (DATA/CSV).
...
```{r bltr_metadata_2014, eval=FALSE, include=FALSE, message=FALSE, echo=FALSE}
...
```{r bltr_metadata_2015, eval=FALSE, include=FALSE, message=FALSE, echo=FALSE}
...
```{r receiver_and_reference_tag_data_2014, eval=FALSE, include=FALSE, message=FALSE, echo=FALSE}
...
```{r receiver_and_reference_tag_data_2015, eval=FALSE, include=FALSE, message=FALSE, echo=FALSE}
...
```{r VPS_data, eval=FALSE, include=FALSE, message=FALSE, echo=FALSE}
...
```{r sunrise_sunset_timing, eval=FALSE, include=FALSE, message=FALSE, echo=FALSE}
...
```{r smolt_migration_data, eval=FALSE, include=FALSE, message=FALSE, echo=FALSE}
...
```{r VPS_data_filtering_prep, eval=FALSE, include=FALSE, message=FALSE, echo=FALSE}
...
```{r Input_and_import_VPS_data, eval=FALSE, include=FALSE, message=FALSE, echo=FALSE}
...
```{r Set_configurations, eval=FALSE, include=FALSE, message=FALSE, echo=FALSE}
...
```{r Evaluate_array_performance, eval=FALSE, include=FALSE, message=FALSE, echo=FALSE}
...
```{r Develop_relationship_b/w_HPE_and_HPEm, eval=FALSE, include=FALSE, message=FALSE, echo=FALSE}
...
```{r Evaluate_filter_metrics_for_reasonable_HPE_values, eval=FALSE, include=FALSE, message=FALSE, echo=FALSE}
...
ggplot(data = AllHPE) +
    ...
    ggrepel::geom_text_repel(cex = 5, aes(x = incorrectRetainPvsRetain, y = incorrectRejectP, label = HPE, group = NULL), 
                             nudge_x = 0.05, nudge_y = 0, max.iter = 50000, max.overlaps = Inf) +
...
```{r Filter_VPS_data, eval=FALSE, include=FALSE, message=FALSE, echo=FALSE}
...
```{r VPS_data_filtering_prep_2015, eval=FALSE, include=FALSE, message=FALSE, echo=FALSE}
...
```{r Input_and_import_VPS_data_2015, eval=FALSE, include=FALSE, message=FALSE, echo=FALSE}
...
```{r Set_configurations_fixed_variables_and_limits_2015, eval=FALSE, include=FALSE, message=FALSE, echo=FALSE}
...
```{r Evaluate_array_performance_2015, eval=FALSE, include=FALSE, message=FALSE, echo=FALSE}
...
```{r Develop_relationship_b/w_HPE_and_HPEm_2015, eval=FALSE, include=FALSE, message=FALSE, echo=FALSE}
...
```{r Evaluate_filter_metrics_for_reasonable_HPE_values_2015, eval=FALSE, include=FALSE, message=FALSE, echo=FALSE}
...
```{r Filter_VPS_data_2015, eval=FALSE, include=FALSE, message=FALSE, echo=FALSE}
...
```{r Clean_up_working_environment, eval=FALSE, include=FALSE, message=FALSE, echo=FALSE}
...
```{r Load_processed_data, eval=FALSE, include=FALSE, message=FALSE, echo=FALSE}
...
```{r Study_area_rasters, eval=FALSE, include=FALSE, message=FALSE, echo=FALSE}
...
```{r Assign_bltr_to_DS_or_US_side_of_the_fence, eval=FALSE, include=FALSE, message=FALSE, echo=FALSE}
...
```{r Load_processed_data_and_movement_metrics_2014, eval=FALSE, include=FALSE, message=FALSE, echo=FALSE}
...
```{r Split_at_gap_function, eval=FALSE, include=FALSE, message=FALSE, echo=FALSE}
...
```{r Compile_AKDE_data_for_analysis, eval=FALSE, include=FALSE, message=FALSE, echo=FALSE}
...
```{r Compile_MVMT_data_for_analysis, eval=FALSE, include=FALSE, message=FALSE, echo=FALSE}
...
```{r Standardize_&_format_covariates, eval=FALSE, include=FALSE, message=FALSE, echo=FALSE}
...
```{r UD_size_2014, eval=FALSE, include=FALSE, message=FALSE, echo=FALSE}
